...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('open-enterprise-master') }}/public/assets/img/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('open-enterprise-master') }}/public/assets/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('open-enterprise-master') }}/public/assets/img/favicons/favicon-16x16.png">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('open-enterprise-master') }}/public/assets/img/favicons/favicon.ico">
    <link rel="manifest" href="{{ asset('open-enterprise-master') }}/public/assets/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="{{ asset('open-enterprise-master') }}/public/assets/img/favicons/mstile-150x150.png">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{ asset('open-enterprise-master') }}/public/assets/css/theme.css" rel="stylesheet" />
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar">
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-xl navbar-light fixed-top px-0 pb-0 mb-2" id="navbar" data-navbar-darken-on-scroll="white">
        <div class="container-fluid align-items-center py-2"><a class="navbar-brand flex-center" href="index.html"><img class="logo" src="{{ asset('open-enterprise-master') }}/public/assets/img/logo.png" alt="open enterprise" /><span class="ms-2 d-none d-sm-block fw-bold">Open Enterprise</span></a>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
          <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto mt-3 mt-xl-0">
              <li class="nav-item ps-0 ps-xl-4 ms-2"><a class="nav-link fs-2 fw-medium" href="#hero"> Home </a></li>
              <li class="nav-item ps-0 ps-xl-4 ms-2"><a class="nav-link fs-2 fw-medium" href="#features"> Pengadaan </a></li>
              <li class="nav-item ps-0 ps-xl-4 ms-2"><a class="nav-link fs-2 fw-medium" href="#contribute"> Admin </a></li>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <section class="pt-8 py-lg-0" id="hero">
        ...
        <div class="container-xxl">
          <div class="row align-items-center min-vh-lg-100">
            <div class="col-lg order-lg-1 text-center"><img class="img-fluid" src="{{ asset('open-enterprise-master') }}/public/assets/img/illustrations/hero.png" alt="" /></div>
          ...
          <div class="row row-cols-1 row-cols-xl-3 g-4 mt-3 text-center">
            <div class="col-12 col-md-6">
              <div class="card py-md-6 px-md-4 mt-3 h-100 box-shadow-all border-0">
                <div class="card-body"><img src="{{ asset('open-enterprise-master') }}/public/assets/img/icons/icon1.png" alt="" />
            ...
            <div class="col-12 col-md-6">
              <div class="card py-md-6 px-md-4 mt-3 h-100 box-shadow-all border-0">
                <div class="card-body"><img src="{{ asset('open-enterprise-master') }}/public/assets/img/icons/icon2.png" alt="" />
            ...
            <div class="col-12">
              <div class="card py-md-6 px-md-4 mt-3 h-100 box-shadow-all border-0">
                <div class="card-body"><img src="{{ asset('open-enterprise-master') }}/public/assets/img/icons/icon3.png" alt="" />
      ...
      <section id="contribute">
        ...
        <div class="container-xxl">
          <div class="row align-items-center">
            <div class="col-md-6"><img src="{{ asset('open-enterprise-master') }}/public/assets/img/icons/icon1.png" alt="" />
            ...
            <div class="col-md-6 col-xl-4 offset-xl-1">
              <div class="card box-shadow-rb my-4">
                <div class="card-body my-3 mx-4">
                  ...
                  <div class="d-flex align-items-center mt-3"><img class="rounded-circle" src="{{ asset('open-enterprise-master') }}/public/assets/img/gallery/user1.png" alt="" height="70" />
                    <div class="ms-3">
                      <h3>Dillon Kydd</h3>
                      <p class="mb-0">100 SHARES</p>
                    </div>
                  </div>
                  <div class="d-flex align-items-center mt-3"><img class="rounded-circle" src="{{ asset('open-enterprise-master') }}/public/assets/img/gallery/user2.png" alt="" height="70" />
                    <div class="ms-3">
                      <h3>Anna Olsen</h3>
                      <p class="mb-0">100 SHARES</p>
                    </div>
                  </div>
                  <div class="d-flex align-items-center mt-3"><img class="rounded-circle" src="{{ asset('open-enterprise-master') }}/public/assets/img/gallery/user3.png" alt="" height="70" />
                    <div class="ms-3">
                      <h3>Kas Moss</h3>
                      <p class="mb-0">100 SHARES</p>
                    </div>
      ...
      <section>
        ...
        <div class="container-xxl">
          <div class="row flex-between-center">
            <div class="col-md-6 order-md-1"><img src="{{ asset('open-enterprise-master') }}/public/assets/img/icons/icon2.png" alt="" />
              ...
              <div class="card my-4">
                <div class="card-body p-0 p-lg-3 my-3 mx-4">
                  <div class="card-title">
                    <div class="d-flex align-items-center mt-3"><img class="rounded-circle" src="{{ asset('open-enterprise-master') }}/public/assets/img/gallery/user4.png" alt="" height="70" />
                      <div class="ms-3">
                        <h3>Jassir Jonis</h3>
                  ...
                  <div class="mt-3 pt-2">
                    <button class="btn btn-dark btn-lg w-100">Go to vote</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section>
        ...
        <div class="container-xxl">
          <div class="row align-items-center gx-1">
            <div class="col-xl-6"><img src="{{ asset('open-enterprise-master') }}/public/assets/img/icons/icon3.png" alt="" />
              ...
              <div class="row justify-content-center gx-4">
                  ...
                  <div class="card px-3 py-4 bg-warning">
                    <div class="card-body">
                      ...
                      <div class="applicant d-flex justify-content-between text-1000">
                        <div class="d-flex align-items-center"><img class="rounded-circle my-2 me-2 me-md-3" src="{{ asset('open-enterprise-master') }}/public/assets/img/gallery/user5.png" alt="" height="40" />
                          <p class="fs-1 fs-md-2 mb-0 fw-semi-bold">Jason Kwon</p>
                        </div>
                        <div class="d-flex align-items-center"><img class="star" src="{{ asset('open-enterprise-master') }}/public/assets/img/icons/star.svg" alt="" />
                          <p class="mb-0 mx-2 fw-medium">4.8</p>
                        </div>
                      </div>
                      <div class="applicant d-flex justify-content-between text-1000">
                        <div class="d-flex align-items-center"><img class="rounded-circle my-2 me-2 me-md-3" src="{{ asset('open-enterprise-master') }}/public/assets/img/gallery/user6.png" alt="" height="40" />
                      ...
                      <div class="applicant d-flex justify-content-between text-1000">
                        <div class="d-flex align-items-center"><img class="rounded-circle my-2 me-2 me-md-3" src="{{ asset('open-enterprise-master') }}/public/assets/img/gallery/user7.png" alt="" height="40" />
                ...
                <div class="col-sm-12 col-md-5">
                  <div class="card p-2 mt-4 mt-md-5 border-success">
                    <div class="card-body">
                      <div class="card-text text-center"><img class="rounded-circle" src="{{ asset('open-enterprise-master') }}/public/assets/img/gallery/axel.png" alt="" height="70" />
                      ...
                      <button class="btn btn-lg btn-dark w-100 mt-3">View Profile</button>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="rea">
        ...
        <div class="container-xxl">
          <div class="row align-items-center">
            <div class="col-lg order-lg-1 text-center"><img class="img-fluid" src="{{ asset('open-enterprise-master') }}/public/assets/img/illustrations/hero2.png" alt="" /></div>
            <div class="col-lg mt-5 mt-lg-0">
              <h1 class="lh-sm font-cursive fw-medium display-5">Start an Open Enterprise</h1>
              <p class="mt-4 fs-1">If you can’t wait to run a new or existing organization on Open Enterprise and are willing to explore and navigate the beta, we’d love to get you started.</p>
              <button class="btn btn-success mt-4">Request early access</button>
            </div>
          </div>
        </div>
    ...
    <script src="{{ asset('open-enterprise-master') }}/public/assets/js/theme.js"></script>
